  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (success) {
        ...
        setError("Invalid credentials. Try officer@forensiq.gov / forensiq123");
      }
      setLoading(false);
    }, 800);
  };
    ...
    <div className="flex h-screen w-screen items-center justify-center bg-background overflow-hidden relative">
      ...
      >
        ...
        <div className="mt-4 rounded-lg border border-border bg-muted/50 px-4 py-3">
          <p className="text-[10px] font-mono uppercase tracking-widest text-muted-foreground mb-2">Demo Credentials</p>
          <div className="space-y-1 text-[11px] font-mono text-muted-foreground">
            <p><span className="text-foreground">officer@forensiq.gov</span> / <span className="text-foreground">forensiq123</span></p>
            <p><span className="text-foreground">admin@forensiq.gov</span> / <span className="text-foreground">admin123</span></p>
          </div>
        </div>
